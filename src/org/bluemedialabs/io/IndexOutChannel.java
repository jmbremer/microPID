 ...
 * @version 1.0
 */
public class IndexOutChannel {
	private WritableDataChannel out;
	private int recordLen;
	private int recordCount = 0;

	public IndexOutChannel(WritableDataChannel out, Storable obj)
			throws IOException {
		this.out = out;
		setRecordLen(obj);
	}
...
//		log.log("IndexOutputStream created with header " + header);
	...
	static public void main(String[] args) throws Exception {
		BufferedOutputChannel boc = BufferedOutputChannel.create("F:/Java/fos.test");
		MutableInteger mutInt = new MutableInteger(1);
		IndexOutChannel ioc = new IndexOutChannel(boc, mutInt);
