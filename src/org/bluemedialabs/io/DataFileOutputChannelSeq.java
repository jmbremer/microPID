 ...
 * @version 1.0
 */
public class DataFileOutputChannelSeq implements DataOutputSequence {
	private FileOutputStream fileOut;
	private int fileCount = 0;
	private BufferedOutputChannel out;
	private String baseFileName;
	private int bufferSize;

	public DataFileOutputChannelSeq(String baseFileName, int bufferSize)
			throws IOException {
		this.baseFileName = baseFileName;
		this.bufferSize = bufferSize;
		fileOut = new FileOutputStream(baseFileName + (++fileCount));
		out = new BufferedOutputChannel(fileOut.getChannel(), bufferSize);
	}
