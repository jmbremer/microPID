...
/**
 * <p>A simpler version of an Index Sequential Access File ({@link IsaFile}) for
 ...
 * @version 1.0
 */
public class IndexFile implements Index {
	protected RandomAccessFile file;
//	protected DataInputStream cha;
	 ...
	 */
	public IndexFile(String name, Storable sample)
			throws FileNotFoundException, IOException {
		// Create underlying file
		// !!! "rw" changed to "r" on 2003jan11:
		try {
 ...
 ****************************************************************************/
	...
	static public class Header implements Storable {
		...
		public int byteSize() {
			return BYTE_SIZE; // 2 ints and 2 longs
		}
	}
